...
import { DSLMastery_PureProtocolProcessorPlugin } from './models/protocols/pure/DSLMastery_PureProtocolProcessorPlugin.js';

export class DSLMastery_GraphPreset extends AbstractPreset {
  constructor() {
